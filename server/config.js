...
module.exports =
{
	...
	https  :
	{
		listenIp   : '172.31.40.233',
		// NOTE: Don't change listenPort (client app assumes 4443).
		listenPort : process.env.PROTOO_LISTEN_PORT || 4443,
		// NOTE: Set your own valid certificate files.
		tls        :
		{
			cert : process.env.HTTPS_CERT_FULLCHAIN || `${__dirname}/certs/subvboxe.com.crt`,
			key  : process.env.HTTPS_CERT_PRIVKEY || `${__dirname}/certs/subvboxe.com.key`
		}
	},
	// mediasoup settings.
	mediasoup :
